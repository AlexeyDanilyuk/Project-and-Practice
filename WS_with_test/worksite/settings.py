...
SECRET_KEY = 't)^mie2puzb9tso4@0@0c4h=im5l5hj)3p2wd#l-&ldno3d+#3'
...
with open('worksite/social_auth.json', 'r') as f:
    SOCIAL = json.load(f)
...
if os.name == 'posix':
    ...
    CACHE_MIDDLEWARE_KEY_PREFIX = 'worksite'
